...
local car0 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 0)
local car1 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 1)
local car2 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 2)
local car3 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 3)
local car4 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 4)
local car5 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 5)
local car6 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 6)
local car7 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 7)
local car8 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 8)
local car9 = assets:loadDisplay("assets/images/car.png"):setPosition(0, 48 * 9)

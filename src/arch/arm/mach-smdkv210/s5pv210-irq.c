/*
 * arch/arm/mach-smdkv210/s5pv210-irq.c
 *
...
static __init void s5pv210_irq_init(void)
{
	...
	for(i = 0; i< 32; i++)
	{
		writel((S5PV210_VIC0_VECTADDR0 + 4 * i), (x_u32)irq);
...
module_init(s5pv210_irq_init, LEVEL_MACH_RES);
module_exit(s5pv210_irq_exit, LEVEL_MACH_RES);

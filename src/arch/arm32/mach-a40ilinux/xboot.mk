...
DEFINES		+=	-D__SANDBOX__ -D__ARM32_ARCH__=7 -D__CORTEX_A7__ -D__ARM32_NEON__

XFLAGS		:= `$(TOPDIR)/../out/sun8iw11p1/linux/common/buildroot/host/usr/bin/pkg-config --cflags libdrm`
XFLAGS		+= -I$(TOPDIR)/../out/sun8iw11p1/linux/common/buildroot/staging/usr/include
XFLAGS		+= -I$(TOPDIR)/../out/sun8iw11p1/linux/common/buildroot/staging/usr/include/drm
XLIBS		:= `$(TOPDIR)/../out/sun8iw11p1/linux/common/buildroot/host/usr/bin/pkg-config --libs libdrm`
XLIBS		+= -L$(TOPDIR)/../out/sun8iw11p1/linux/common/buildroot/staging/usr/lib

...
static void mctl_set_master_priority(void)
{
	...
	write32(&com->mcr[0][0] , 0x0200000d);
	write32(&com->mcr[0][1] , 0x00800100);
	write32(&com->mcr[1][0] , 0x06000009);
	write32(&com->mcr[1][1] , 0x01000400);
	write32(&com->mcr[2][0] , 0x0200000d);
	write32(&com->mcr[2][1] , 0x00600100);
	write32(&com->mcr[3][0] , 0x0100000d);
	write32(&com->mcr[3][1] , 0x00200080);
	write32(&com->mcr[4][0] , 0x07000009);
	write32(&com->mcr[4][1] , 0x01000640);
	write32(&com->mcr[5][0] , 0x0100000d);
	write32(&com->mcr[5][1] , 0x00200080);
	write32(&com->mcr[6][0] , 0x01000009);
	write32(&com->mcr[6][1] , 0x00400080);
	write32(&com->mcr[7][0] , 0x0100000d);
	write32(&com->mcr[7][1] , 0x00400080);
	write32(&com->mcr[8][0] , 0x0100000d);
	write32(&com->mcr[8][1] , 0x00400080);
	write32(&com->mcr[9][0] , 0x04000009);
	write32(&com->mcr[9][1] , 0x00400100);
	write32(&com->mcr[10][0], 0x2000030d);
	write32(&com->mcr[10][1], 0x04001800);
	write32(&com->mcr[11][0], 0x04000009);
	write32(&com->mcr[11][1], 0x00400120);
}

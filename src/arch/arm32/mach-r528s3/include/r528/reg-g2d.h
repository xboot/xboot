#ifndef __R528_REG_G2D_H__
#define __R528_REG_G2D_H__

#include <types.h>

#define R528_G2D_BASE		(0x05410000)

#define R528_G2D_TOP		(0x00000000)
#define R528_G2D_MIXER		(0x00000100)
#define R528_G2D_BLD		(0x00000400)
#define R528_G2D_V0			(0x00000800)
#define R528_G2D_UI0		(0x00001000)
#define R528_G2D_UI1		(0x00001800)
#define R528_G2D_UI2		(0x00002000)
#define R528_G2D_WB			(0x00003000)
#define R528_G2D_VSU		(0x00008000)
#define R528_G2D_ROT		(0x00028000)
#define R528_G2D_GSU		(0x00030000)

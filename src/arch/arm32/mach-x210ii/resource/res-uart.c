...
static struct s5pv210_uart_data_t s5pv210_uart_data[] = {
	[0] = {
		.baud		= B115200,
		.data		= DATA_BITS_8,
		.parity		= PARITY_NONE,
		.stop		= STOP_BITS_1,
		.regbase	= S5PV210_UART0_BASE,
	},
	[1] = {
		.baud		= B115200,
		.data		= DATA_BITS_8,

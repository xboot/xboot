...
static void s5p4418_gpiochip_set_cfg(struct gpiochip_t * chip, int offset, int cfg)
{
	...
	{
		offset <<= 0x1;
		val = read32(dat->regbase + S5P4418_GPIO_ALTFN0);
		val &= ~(0x3 << offset);
		val |= cfg << offset;
		write32(dat->regbase + S5P4418_GPIO_ALTFN0, val);
	}
	else if(offset < 32)
	{
		offset <<= 0x1;
		val = read32(dat->regbase + S5P4418_GPIO_ALTFN1);
		val &= ~(0x3 << offset);
		val |= cfg << offset;
		write32(dat->regbase + S5P4418_GPIO_ALTFN1, val);
	}
}
...
static void s5p4418_gpiochip_set_pull(struct gpiochip_t * chip, int offset, enum gpio_pull_t pull)
{
	...
	{
	case GPIO_PULL_UP:
		val = read32(dat->regbase + S5P4418_GPIO_PULLSEL);
		val |= 1 << offset;
		write32(dat->regbase + S5P4418_GPIO_PULLSEL, val);
		val = read32(dat->regbase + S5P4418_GPIO_PULLENB);
		val |= 1 << offset;
		write32(dat->regbase + S5P4418_GPIO_PULLENB, val);
		break;
	...
	val = read32(dat->regbase + S5P4418_GPIO_PULLSEL_DISABLE_DEFAULT);
	val |= 1 << offset;
	write32(dat->regbase + S5P4418_GPIO_PULLSEL_DISABLE_DEFAULT, val);
	val = read32(dat->regbase + S5P4418_GPIO_PULLENB_DISABLE_DEFAULT);
	val |= 1 << offset;
	write32(dat->regbase + S5P4418_GPIO_PULLENB_DISABLE_DEFAULT, val);
}
...
static void s5p4418_gpiochip_set_drv(struct gpiochip_t * chip, int offset, enum gpio_drv_t drv)
{
	...
	{
	case GPIO_DRV_LOW:
		val = read32(dat->regbase + S5P4418_GPIO_DRV0);
		val &= ~(1 << offset);
		write32(dat->regbase + S5P4418_GPIO_DRV0, val);
		val = read32(dat->regbase + S5P4418_GPIO_DRV1);
		val &= ~(1 << offset);
		write32(dat->regbase + S5P4418_GPIO_DRV1, val);
		break;
	...
	val = read32(dat->regbase + S5P4418_GPIO_DRV0_DISABLE_DEFAULT);
	val |= 1 << offset;
	write32(dat->regbase + S5P4418_GPIO_DRV0_DISABLE_DEFAULT, val);
	val = read32(dat->regbase + S5P4418_GPIO_DRV1_DISABLE_DEFAULT);
	val |= 1 << offset;
	write32(dat->regbase + S5P4418_GPIO_DRV1_DISABLE_DEFAULT, val);
}
...
static void s5p4418_gpiochip_set_dir(struct gpiochip_t * chip, int offset, enum gpio_direction_t dir)
{
	...
	case GPIO_DIRECTION_INPUT:
		val = read32(dat->regbase + S5P4418_GPIO_OUTENB);
		val &= ~(0x1 << offset);
		write32(dat->regbase + S5P4418_GPIO_OUTENB, val);
		break;
...
static void s5p4418_gpiochip_set_value(struct gpiochip_t * chip, int offset, int value)
{
	...
	val = read32(dat->regbase + S5P4418_GPIO_OUT);
	val &= ~(1 << offset);
	val |= (!!value) << offset;
	write32(dat->regbase + S5P4418_GPIO_OUT, val);
}

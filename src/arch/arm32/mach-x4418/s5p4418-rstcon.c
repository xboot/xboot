...
{
	virtual_addr_t virt = phys_to_virt(S5P4418_SYS_IP_RSTCON0);
	u32_t val;

	if(id < 32)
		virt = phys_to_virt(S5P4418_SYS_IP_RSTCON0);
	else if(id < 64)
		virt = phys_to_virt(S5P4418_SYS_IP_RSTCON1);
	else if(id < 96)
		virt = phys_to_virt(S5P4418_SYS_IP_RSTCON2);
	else
		return;

...
XFLAGS		:= `~/9tripod/rockchip/px30_linux/buildroot/output/rockchip_px30_64/host/bin/pkg-config --cflags libdrm`
XLIBS		:= `~/9tripod/rockchip/px30_linux/buildroot/output/rockchip_px30_64/host/bin/pkg-config --libs libdrm`

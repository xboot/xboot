...
static struct irqchip_data_t datas[] = {
	{
		...
		.base		= 0,
		.nirq		= 32,
		.physpend	= BCM2837_IRQ_BASE + IRQ_PEND1,
		.physenable	= BCM2837_IRQ_BASE + IRQ_ENABLE1,
		.physdisable= BCM2837_IRQ_BASE + IRQ_DISABLE1,
	}, {
		.name		= "GPUIRQ",
		.base		= 32,
		.nirq		= 32,
		.physpend	= BCM2837_IRQ_BASE + IRQ_PEND2,
		.physenable	= BCM2837_IRQ_BASE + IRQ_ENABLE2,
		.physdisable= BCM2837_IRQ_BASE + IRQ_DISABLE2,
	}, {
		.name		= "ARMIRQ",
		.base		= 64,
		.nirq		= 8,
		.physpend	= BCM2837_IRQ_BASE + IRQ_PEND_BASIC,
		.physenable	= BCM2837_IRQ_BASE + IRQ_ENABLE_BASIC,
		.physdisable= BCM2837_IRQ_BASE + IRQ_DISABLE_BASIC,
	}
};
...
static __init void bcm2837_irqchip_init(void)
{

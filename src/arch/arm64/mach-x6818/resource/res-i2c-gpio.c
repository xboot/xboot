...
static struct i2c_gpio_data_t i2c_gpio_datas[] = {
	[0] = {
		.sda_pin			= S5P6818_GPIOD(3),
		.scl_pin			= S5P6818_GPIOD(2),
		.udelay				= 5,
		.sda_is_open_drain	= 0,
		.scl_is_open_drain	= 0,
	...
	[1] = {
		.sda_pin			= S5P6818_GPIOD(5),
		.scl_pin			= S5P6818_GPIOD(4),
		.udelay				= 5,
		.sda_is_open_drain	= 0,
		.scl_is_open_drain	= 0,
		.scl_is_output_only	= 0,
	...
	[2] = {
		.sda_pin			= S5P6818_GPIOD(7),
		.scl_pin			= S5P6818_GPIOD(6),
		.udelay				= 5,
		.sda_is_open_drain	= 0,
		.scl_is_open_drain	= 0,
		.scl_is_output_only	= 0,
	...
	[3] = {
		.sda_pin			= S5P6818_GPIOC(16),
		.scl_pin			= S5P6818_GPIOC(15),
		.udelay				= 5,
		.sda_is_open_drain	= 0,
		.scl_is_open_drain	= 0,
		.scl_is_output_only	= 0,

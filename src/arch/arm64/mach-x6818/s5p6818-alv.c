...
static const char * s5p6818_gpiochip_alv_to_irq(struct gpiochip_t * chip, int offset)
{
...
struct gpiochip_t gpiochip_alv = {
	...
	.to_irq		= s5p6818_gpiochip_alv_to_irq,
	.priv		= &gpiochip_alv_data,
};

static __init void s5p6818_gpiochip_alv_init(void)
{
...
static __exit void s5p6818_gpiochip_alv_exit(void)
{
...
core_initcall(s5p6818_gpiochip_alv_init);
core_exitcall(s5p6818_gpiochip_alv_exit);

...
static struct clk_mux_t core_mux_clks[] = {
	{
		...
		.shift = 0,
		.width = 3,
		.phys = S5P6818_SYS_CLKDIVREG0,
	}, {
		.name = "MUX-BCLK",
		.parent = pll_mux_tables,
		.shift = 0,
		.width = 3,
		.phys = S5P6818_SYS_CLKDIVREG1,
	}, {
		.name = "MUX-MDCLK",
		.parent = pll_mux_tables,
		.shift = 0,
		.width = 3,
		.phys = S5P6818_SYS_CLKDIVREG2,
	}, {
		.name = "MUX-GR3DBCLK",
		.parent = pll_mux_tables,
		.shift = 0,
		.width = 3,
		.phys = S5P6818_SYS_CLKDIVREG3,
	}, {
		.name = "MUX-MPEGBCLK",
		.parent = pll_mux_tables,
		.shift = 0,
		.width = 3,
		.phys = S5P6818_SYS_CLKDIVREG4,
	}
};
...
static struct clk_divider_t core_div_clks[] = {
	{
		...
		.shift = 0,
		.width = 8,
		.phys = S5P6818_TIMER_BASE + TIMER_TCFG0,
	}, {
		...
		.shift = 0,
		.width = 8,
		.phys = S5P6818_PWM_BASE + PWM_TCFG0,
	}, {
...
static struct clk_mux_t uart_mux_clks[] = {
	{
		...
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART0CLKGEN0L,
	}, {
		.name = "MUX-UART1",
		.parent = uart_mux_tables,
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART1CLKGEN0L,
	}, {
		.name = "MUX-UART2",
		.parent = uart_mux_tables,
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART2CLKGEN0L,
	}, {
		.name = "MUX-UART3",
		.parent = uart_mux_tables,
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART3CLKGEN0L,
	}, {
		.name = "MUX-UART4",
		.parent = uart_mux_tables,
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART4CLKGEN0L,
	}, {
		.name = "MUX-UART5",
		.parent = uart_mux_tables,
		.shift = 2,
		.width = 3,
		.phys = S5P6818_CLK_UART5CLKGEN0L,
	}
};
...
static struct clk_gate_t uart_gate_clks[] = {
	{
		...
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART0CLKENB,
	}, {
		.name = "GATE-UART1",
		.parent = "DIV-UART1",
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART1CLKENB,
	}, {
		.name = "GATE-UART2",
		.parent = "DIV-UART2",
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART2CLKENB,
	}, {
		.name = "GATE-UART3",
		.parent = "DIV-UART3",
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART3CLKENB,
	}, {
		.name = "GATE-UART4",
		.parent = "DIV-UART4",
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART4CLKENB,
	}, {
		.name = "GATE-UART5",
		.parent = "DIV-UART5",
		.shift = 1,
		.invert = 0,
		.phys = S5P6818_CLK_UART5CLKENB,
	}
};
...
static __init void s5p6818_clk_init(void)
{
	/*
...
core_initcall(s5p6818_clk_init);

...
static struct irq_handler_t s5p6818_irq_handler[64];
...
void do_irq(void * regs)
{
	...
	(s5p6818_irq_handler[irq - 32].func)(s5p6818_irq_handler[irq - 32].data);
...
static struct irq_t s5p6818_irqs[] = {
	/* ... */
	{
		...
		.name		= "UART4",
		.no			= 10,
		.handler	= &s5p6818_irq_handler[10],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "UART5",
		.no			= 11,
		.handler	= &s5p6818_irq_handler[11],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SSP0",
		.no			= 12,
		.handler	= &s5p6818_irq_handler[12],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SSP1",
		.no			= 13,
		.handler	= &s5p6818_irq_handler[13],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SSP2",
		.no			= 14,
		.handler	= &s5p6818_irq_handler[14],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "I2C0",
		.no			= 15,
		.handler	= &s5p6818_irq_handler[15],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "I2C1",
		.no			= 16,
		.handler	= &s5p6818_irq_handler[16],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "I2C2",
		.no			= 17,
		.handler	= &s5p6818_irq_handler[17],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "DEINTERLACE",
		.no			= 18,
		.handler	= &s5p6818_irq_handler[18],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SCALER",
		.no			= 19,
		.handler	= &s5p6818_irq_handler[19],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "AC97",
		.no			= 20,
		.handler	= &s5p6818_irq_handler[20],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SPDIFRX",
		.no			= 21,
		.handler	= &s5p6818_irq_handler[21],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SPDIFTX",
		.no			= 22,
		.handler	= &s5p6818_irq_handler[22],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "TIMER0",
		.no			= 23,
		.handler	= &s5p6818_irq_handler[23],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "TIMER1",
		.no			= 24,
		.handler	= &s5p6818_irq_handler[24],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
	...
	/* ... */
	{
		.name		= "MPEGTSI",
		.no			= 32,
		.handler	= &s5p6818_irq_handler[32],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "DISPLAYTOP0",
		.no			= 33,
		.handler	= &s5p6818_irq_handler[33],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "DISPLAYTOP1",
		.no			= 34,
		.handler	= &s5p6818_irq_handler[34],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "DISPLAYTOP2",
		.no			= 35,
		.handler	= &s5p6818_irq_handler[35],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "DISPLAYTOP3",
		.no			= 36,
		.handler	= &s5p6818_irq_handler[36],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "VIP0",
		.no			= 37,
		.handler	= &s5p6818_irq_handler[37],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "VIP1",
		.no			= 38,
		.handler	= &s5p6818_irq_handler[38],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "MIPI",
		.no			= 39,
		.handler	= &s5p6818_irq_handler[39],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "3DGPU",
		.no			= 40,
		.handler	= &s5p6818_irq_handler[40],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "ADC",
		.no			= 41,
		.handler	= &s5p6818_irq_handler[41],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "PPM",
		.no			= 42,
		.handler	= &s5p6818_irq_handler[42],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SDMMC0",
		.no			= 43,
		.handler	= &s5p6818_irq_handler[43],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SDMMC1",
		.no			= 44,
		.handler	= &s5p6818_irq_handler[44],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "SDMMC2",
		.no			= 45,
		.handler	= &s5p6818_irq_handler[45],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "CODA9600",
		.no			= 46,
		.handler	= &s5p6818_irq_handler[46],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "CODA9601",
		.no			= 47,
		.handler	= &s5p6818_irq_handler[47],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "GMAC",
		.no			= 48,
		.handler	= &s5p6818_irq_handler[48],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "USB20OTG",
		.no			= 49,
		.handler	= &s5p6818_irq_handler[49],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "USB20HOST",
		.no			= 50,
		.handler	= &s5p6818_irq_handler[50],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "CRYPTO",
		.no			= 58,
		.handler	= &s5p6818_irq_handler[58],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "PDM",
		.no			= 59,
		.handler	= &s5p6818_irq_handler[59],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "TMU0",
		.no			= 60,
		.handler	= &s5p6818_irq_handler[60],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	}, {
		.name		= "TMU1",
		.no			= 61,
		.handler	= &s5p6818_irq_handler[61],
		.enable		= s5p6818_irq_enable,
		.disable	= s5p6818_irq_disable,
		.set_type	= s5p6818_irq_set_type,
	},

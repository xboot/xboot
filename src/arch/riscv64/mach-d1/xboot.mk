...
MCFLAGS		:= -march=rv64imafdc -mabi=lp64d -mcmodel=medlow -fno-stack-protector
...
xend:
	...
	@$(MKSUNXI) $(X_NAME).bin
	@$(MKZ) -majoy 3 -minior 0 -patch 0 -r 65536 -i $(BINDID) -k $(ENCRYPT_KEY) -pb $(PUBLIC_KEY) -pv $(PRIVATE_KEY) -m $(MESSAGE) $(X_NAME).bin $(X_NAME).bin.z

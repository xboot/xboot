...
enum {
	...
	CFG_UARTHS_RX		= 18,  /* UART High speed I2S_RECEIVER */
	CFG_UARTHS_TX		= 19,  /* UART High speed I2S_TRANSMITTER */
	...
	CFG_UART1_RX		= 64,  /* UART1 I2S_RECEIVER */
	CFG_UART1_TX		= 65,  /* UART1 I2S_TRANSMITTER */
	CFG_UART2_RX		= 66,  /* UART2 I2S_RECEIVER */
	CFG_UART2_TX		= 67,  /* UART2 I2S_TRANSMITTER */
	CFG_UART3_RX		= 68,  /* UART3 I2S_RECEIVER */
	CFG_UART3_TX		= 69,  /* UART3 I2S_TRANSMITTER */
	...
	CFG_UART1_RE		= 159, /* UART1 I2S_RECEIVER Output Enable */
	...
	CFG_UART2_RE		= 173, /* UART2 I2S_RECEIVER Output Enable */
	...
	CFG_UART3_RE		= 187, /* UART3 I2S_RECEIVER Output Enable */

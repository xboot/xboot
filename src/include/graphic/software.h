...
bool_t software_fill_rects(struct surface_t * surface, const struct rect_t * rects, u32_t count, u32_t c, enum blend_mode mode);
bool_t software_blit(struct surface_t * dst, struct rect_t * dst_rect, struct surface_t * src, struct rect_t * src_rect, enum blend_mode mode);

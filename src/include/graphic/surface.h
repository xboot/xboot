...
struct render_t
{
	...
	void (*filter_glow)(struct surface_t * s, struct color_t * c, int strength);
};
...
static inline void surface_filter_glow(struct surface_t * s, struct color_t * c, int strength)
{
	s->r->filter_glow(s, c, strength);
}

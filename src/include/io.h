...
u8_t read8(virtual_addr_t addr)
{
	return( *((volatile u8_t *)(addr)) );
}

static inline __attribute__((__always_inline__))
u16_t read16(virtual_addr_t addr)
{
...
static inline __attribute__((__always_inline__))
u64_t read64(virtual_addr_t addr)
{
	return( *((volatile u64_t *)(addr)) );
}

static inline __attribute__((__always_inline__))
void write8(virtual_addr_t addr, u8_t value)
{
	*((volatile u8_t *)(addr)) = value;
}

static inline __attribute__((__always_inline__))
void write16(virtual_addr_t addr, u16_t value)
{
...
static inline __attribute__((__always_inline__))
void write64(virtual_addr_t addr, u64_t value)
{

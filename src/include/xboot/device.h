...
enum device_type_t {
	...
	DEVICE_TYPE_LED				= 20,
	DEVICE_TYPE_LEDSTRIP		= 21,
	DEVICE_TYPE_LEDTRIGGER		= 22,
	DEVICE_TYPE_LIGHT			= 23,
	DEVICE_TYPE_MOTOR			= 24,
	DEVICE_TYPE_NVMEM			= 25,
	...
	DEVICE_TYPE_SERVO			= 34,
	DEVICE_TYPE_SPI				= 35,
	DEVICE_TYPE_STEPPER			= 36,
	DEVICE_TYPE_THERMOMETER		= 37,
	DEVICE_TYPE_UART			= 38,
	DEVICE_TYPE_VIBRATOR		= 39,
	DEVICE_TYPE_WATCHDOG		= 40,

	DEVICE_TYPE_MAX_COUNT		= 41,
};

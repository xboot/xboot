...
enum device_type_t {
	...
	DEVICE_TYPE_CLK			= 4,
	DEVICE_TYPE_CLOCKEVENT	= 5,
	DEVICE_TYPE_CLOCKSOURCE	= 6,
	DEVICE_TYPE_CONSOLE		= 7,
	DEVICE_TYPE_DISK		= 8,
	DEVICE_TYPE_FB			= 9,
	DEVICE_TYPE_GPIOCHIP	= 10,
	DEVICE_TYPE_I2C			= 11,
	DEVICE_TYPE_INPUT		= 12,
	DEVICE_TYPE_IRQCHIP		= 13,
	DEVICE_TYPE_LED			= 14,
	DEVICE_TYPE_LEDTRIG		= 15,
	DEVICE_TYPE_PWM			= 16,
	DEVICE_TYPE_REGULATOR	= 17,
	DEVICE_TYPE_RNG			= 18,
	DEVICE_TYPE_RTC			= 19,
	DEVICE_TYPE_SPI			= 20,
	DEVICE_TYPE_UART		= 21,
	DEVICE_TYPE_VIBRATOR	= 22,
	DEVICE_TYPE_WATCHDOG	= 23,

	DEVICE_TYPE_MAX_COUNT	= 24,
};

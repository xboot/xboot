...
#define resource_initcall_sync(fn)	__define_initcall("4s", fn, 4s)
#define bus_initcall(fn)			__define_initcall("5",  fn, 5)
#define bus_initcall_sync(fn)		__define_initcall("5s", fn, 5s)
...
#define resource_exitcall_sync(fn)	__define_exitcall("4s", fn, 4s)
#define bus_exitcall(fn)			__define_exitcall("5",  fn, 5)
#define bus_exitcall_sync(fn)		__define_exitcall("5s", fn, 5s)

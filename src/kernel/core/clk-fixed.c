...
static void clk_fixed_set_parent(struct clk_t * clk, const char * name)
{
}

static char * clk_fixed_get_parent(struct clk_t * clk)
{
	return NULL;
}
...
static void clk_fixed_set_rate(struct clk_t * clk, u64_t parent, u64_t rate)
{
}

static u64_t clk_fixed_get_rate(struct clk_t * clk, u64_t parent)
{
